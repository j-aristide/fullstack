...
public class Exception101 {
    public static void main(String[] args) {
        ...
        // Exploring out-of-box generated exception (ArrayIndexOutOfBoundsException)
        int array[] = {1,2};

        // The array is initialized with 2 values (1 and 2)
        // This throws an ArrayIndexOutOfBoundsException since the array has been sized to only hold 2 values
